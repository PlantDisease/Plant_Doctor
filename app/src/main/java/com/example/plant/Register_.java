...
public class Register_ extends AppCompatActivity {
                    ...
                    if (Name.length() <= 2) {
                        ...
                        if (!isUpdate) {
                            if (email.length() == 0) {
                                ...
                                Toast.makeText(Register_.this, "Password did not match!", Toast.LENGTH_LONG)
                                        .show();
                                retypePassword.requestFocusFromTouch();
                            } else {
                                pd.show();
                                mAuth.createUserWithEmailAndPassword(email, password)
                                        .addOnCompleteListener(Register_.this, new OnCompleteListener<AuthResult>() {
                                            @Override
                                            public void onComplete(@NonNull Task<AuthResult> task) {

                                                if (!task.isSuccessful()) {
                                                    Toast.makeText(Register_.this, "Registration failed! try agian.", Toast.LENGTH_LONG)
                                                            .show();
    ...
    private void ShowError(String error) {
        ...
        Toast.makeText(Register_.this, "Please, Enter a valid "+error,
